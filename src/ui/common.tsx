...
export const s = StyleSheet.create({
  ...
  card: { backgroundColor: c.surface, borderRadius: 16, borderWidth: 1, borderColor: c.border, padding: 20, gap: 16 }, button: { backgroundColor: '#C91D2C', minHeight: 50, borderRadius: 10, padding: 14, alignItems: 'center', justifyContent: 'center' }, secondary: { backgroundColor: c.surface, borderWidth: 1, borderColor: '#666C77' }, buttonText: { color: 'white', fontSize: 15, fontWeight: '700', textAlign: 'center' },
  input: { backgroundColor: '#FAFAFA', color: '#101113', minHeight: 52, padding: 14, borderRadius: 8, fontSize: 18 }, message: { color: '#FFB1B7', fontSize: 14, lineHeight: 22 }, footer: { color: c.muted, fontSize: 11, letterSpacing: 2, textAlign: 'center', marginVertical: 20 },
});
